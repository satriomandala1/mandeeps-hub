                ...
                TextChatService.OnIncomingMessage = function(data)
                    ...
                    if TextSource then
                        ...
                        if plr then
                            ...
                            properties.PrefixText = string.format("%s", prefix)
                        end
                    end
...
-- ... (semua code kamu di atas biarin aja jangan dihapus)

-- Bagian loader Voidware ganti ke repo kamu
local commit = "main"
loadstring(game:HttpGet("https://raw.githubusercontent.com/satriomandala1/mandeeps-hub/"..commit.."/newnightsintheforest.lua", true))()
